...
<!-- start contact -->
    	<section id="contact">
    		<div class="container">
    			<div class="row">
    				<div class="col-md-12">
        <h2 align="center"  style="font-size: 55px;color: white">CONTACT <span style="color: #28A6E8;      font-family: 'Open Sans', sans-serif;">GrameenShilpo</span></h2>
    				</div>
    				...
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
    					<address>
    						...
    						<p style="color: white"><i class="fa fa-phone"></i> <a style="color: white" href="tel:+8801718339135">+88 01796442049</a></p>
    						<p style="color: white"><i class="fa fa-envelope-o"></i> GrameenShilpo@gmail.com</p>
    						<p style="color: white"><i class="fa fa-map-marker"></i> Daffodil,Ashulia, Dhaka, Bangladesh</p>
    					</address>
